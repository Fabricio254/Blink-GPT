"""
Blink Responde - Sistema de Perguntas e Respostas
...
def main():
    ...
    with col1:
        ...
        <div style="background: linear-gradient(90deg, {COLORS['secondary']} 0%, {COLORS['primary']} 100%); 
            ...
            <h1 style="color: white; margin: 0;">🚀 Blink Responde</h1>
    ...
    <small>
    🏢 <strong>Blink Jeans</strong> | Blink Responde v2.0<br>
